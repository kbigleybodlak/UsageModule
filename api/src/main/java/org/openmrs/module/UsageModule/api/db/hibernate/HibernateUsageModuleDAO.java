...
public class HibernateUsageModuleDAO implements UsageModuleDAO {
    ...
    @Override
    public List<Object> getPatientUsages_Json(Date start, Date until) {
        //throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
        //get the current Session object
        Session session = sessionFactory.getCurrentSession();
        //creat a hibernate query
    ...
    @Override
    public List<Object> getVisitUsages_Json(Date start, Date until) {
        //throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
        //get the current Session object
        Session session = sessionFactory.getCurrentSession();
        //creat a hibernate query
    ...
    @Override
    public List<Object> getOrderUsages_Json(Date start, Date until) {
        //throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
        //get the current Session object
        Session session = sessionFactory.getCurrentSession();
        //creat a hibernate query
