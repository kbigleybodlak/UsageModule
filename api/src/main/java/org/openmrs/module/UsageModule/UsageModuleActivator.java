 ...
 */
public class UsageModuleActivator implements ModuleActivator {
	...
	public void willRefreshContext() {
		log.info("Refreshing UsageModule Module");
	}
	...
	public void contextRefreshed() {
		log.info("UsageModule Module refreshed");
	}
	...
	public void willStart() {
		log.info("Starting UsageModule Module");
	}
	 ...
	 */
	public void started() {
		log.info("UsageModule Module started");
	}
	...
	public void willStop() {
		log.info("Stopping UsageModule Module");
	}
	 ...
	 */
	public void stopped() {
		log.info("UsageModule Module stopped");
	}
